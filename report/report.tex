...
\begin{titlepage}
  ...
  \vspace{0.4cm}
  \begin{tabular}{ccc}
    \textbf{Achyutananda Sahoo} & \textbf{Satyajit Priyadarshi} & \textbf{Shubhadeep Mandal} \\
    \texttt{2025202028} & \texttt{2025101055} & \texttt{2025201054} \\
  \end{tabular}\\[0.8cm]

  \small
  \textbf{Repository:} \url{https://github.com/Seronic2001/Assignment-3/tree/recommendation-system} \\[0.4em]
  \textbf{Live Website:} \url{https://smaia3-assignment-3-team-dhurandhar.streamlit.app/} \\[0.4em]
  \textbf{Dataset:} \url{https://github.com/kanishk307/IndianFoodDatasetGeneration} \\[5em]
  \normalsize
