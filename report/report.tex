...
\begin{titlepage}
  ...
  {\large\textbf{Team Dhurandhar}\par}
  \vspace{0.4cm}
  \begin{tabular}{cc}
    \textbf{Achyutananda Sahoo} & \textbf{Satyajit Priyadarshi} \\
    \texttt{2025202028} & \texttt{2025201055} \\
    \small \texttt{achyutananda.sahoo@students.iiit.ac.in} & \small \texttt{satyajit.priyadarshi@students.iiit.ac.in} \\
  \end{tabular}\\[0.6cm]
  \centering
  \textbf{Shubhadeep Mandal} \\
  \texttt{2025201056} \\
  \small \texttt{shubhadeep.mandal@students.iiit.ac.in} \\[0.8cm]

  \small
  {\normalsize\href{https://github.com/Seronic2001/Assignment-3/tree/recommendation-system}{Github Repository [CLICK HERE]}\par} \\ [0.4em]
  {\normalsize\href{https://smaia3-assignment-3-team-dhurandhar.streamlit.app/}{Live Website [CLICK HERE]}\par} \\ [0.4em]
  {\normalsize\href{https://github.com/kanishk307/IndianFoodDatasetGeneration}{Dataset Link [CLICK HERE]}\par} \\[5em]
...
We use the \textbf{Indian Food Dataset} available on
Kaggle - {\normalsize\href{https://github.com/kanishk307/IndianFoodDatasetGeneration}{Dataset Link [CLICK HERE]}\par} \\[5em]
...
\texttt{sentence-transformers} library. It maps any text string to
...
\textbf{FAISS} (Facebook AI Similarity Search) provides
...
\begin{figure}[H]
  \centering
  \includegraphics[width=1\textwidth]{metrics1.png}
  \caption{Ranked recipes - query : "fish, onion"}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=1\textwidth]{fav.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.45\textwidth]{dev_tools.png}
  \caption{Recommender tab}
\end{figure}
...
\begin{enumerate}
  ...
  \item \textbf{Indian Food Dataset — Kaggle}\\
        \url{https://github.com/kanishk307/IndianFoodDatasetGeneration}\\
        6,000+ Indian recipes with ingredients, cuisine, diet, and time metadata.

  \item \textbf{Sentence Transformers — all-MiniLM-L6-v2}\\
        \url{https://huggingface.co/sentence-transformers/all-MiniLM-L6-v2}\\
        Lightweight pre-trained 384-dimensional sentence embedding model.
\end{enumerate}
